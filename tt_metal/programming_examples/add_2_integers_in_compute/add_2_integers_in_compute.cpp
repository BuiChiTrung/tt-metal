...
int main(int argc, char **argv) {
    ...
    auto data_type = tt::DataFormat::Bfp8_b;
    constexpr uint32_t single_tile_size = 1088;
    ...
    CircularBufferConfig cb_src0_config =
        CircularBufferConfig(num_input_tiles * single_tile_size, {{src0_cb_index, data_type}})
            .set_page_size(src0_cb_index, single_tile_size);
    CBHandle cb_src0 = tt_metal::CreateCircularBuffer(program, core, cb_src0_config);

    constexpr uint32_t src1_cb_index = CB::c_in1;
    CircularBufferConfig cb_src1_config =
        CircularBufferConfig(num_input_tiles * single_tile_size, {{src1_cb_index, data_type}})
    ...
    CircularBufferConfig cb_output_config =
        CircularBufferConfig(num_output_tiles * single_tile_size, {{output_cb_index, data_type}})
    ...
    src0_vec = create_constant_vector_of_bfp8(single_tile_size, 2.3f, false);
    src1_vec = create_constant_vector_of_bfp8(single_tile_size, 3.2f, false);
